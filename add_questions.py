import tkinter as tk from tkinter import ttk, messagebox import csv import os
...
List of sections and rarities

SECTIONS = ["A", "B", "C", "D", "E"] RARITIES = ["most imp", "sometimes", "rarely"]

GUI main app

class QuestionEntryApp: def init(self, root): self.root = root self.root.title("Add Question to CSV") self.root.geometry("600x500")
...
def toggle_mcq_options(self, event):
...
if name == "main": root = tk.Tk() app = QuestionEntryApp(root) root.mainloop()
